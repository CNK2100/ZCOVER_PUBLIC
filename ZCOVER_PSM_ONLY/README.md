...
## Run ZCOVER:
To run this code, user should know their Z-Wave Home ID (e.g., C6BD818E) and Node ID (e.g., controller ID = 01).
...
## Stop ZCOVER
Fuzzing time can be set manually depending on each use case and  here we set it to 24 hours.

```
CTRL + Z
```

## Verifing and retransmitting logged packet or custom ones.

You can  test a log packet generated during fuzz testing. 
